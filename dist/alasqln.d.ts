// Project: https://github.com/agershun/alasqln
...
declare namespace alaSQLSpace {
    ...
    // see https://github.com/agershun/alasqln/wiki/User%20Defined%20Functions
    interface userDefinedFunction1 {
        (x: any): any;
    }
    interface userDefinedFunctionLookUp1 {
        [x: string]: userDefinedFunction1;
    }
    // see https://github.com/agershun/alasqln/wiki/User%20Defined%20Functions
    interface userAggregator1{
        (value: any, accumulator: any, stage: number): any;
    }
    interface userAggregatorLookUp1 {
        [x: string]: userAggregator1;
    }
    ...
    interface AlaSQL {
        ...
        fn: userDefinedFunctionLookUp1;
        aggr: userAggregatorLookUp1;
        autoval(tablename: string, colname: string, getNext?:boolean): number;
        yy:{};
    }
}

declare var alasqln: alaSQLSpace.AlaSQL;
declare module 'alasqln' {
    export = alasqln;
}
